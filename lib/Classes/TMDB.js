...
var TV_1 = require("./TV");
var TMDB = /** @class */ (function (_super) {
    __extends(TMDB, _super);
     ...
     */
    TMDB.prototype.discover = function (type, query) {
        if (type === void 0) { type = 'movie'; }
        if (query === void 0) { query = []; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (type === 'movie' || type === undefined) {
                    return [2 /*return*/, this.discoverMovies(query)];
                }
                else if (type === 'tv') {
                    return [2 /*return*/, this.discoverTv(query)];
                }
                return [2 /*return*/];
            });
        });
